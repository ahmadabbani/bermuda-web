    ...
    <div className="aboutus-wrapper">
      ...
      <div className="aboutus-content-box">
        <p className="aboutus-text">
          ...
          pride in our expertise in procuring gift cards from popular platforms
          such as PUBG, Jawkker, TikTok, and an array of other exciting
          products. Our mission is to make every gifting occasion special and
          memorable. Whether you're looking to reward your clients, show
          appreciation, or celebrate a special event,{" "}
          <span className="aboutus-brand">Bermuda</span> has you covered.
          <br />
          <br />
          Visit us at <span className="aboutus-brand">bermuda-tech.com</span> to
          explore our diverse range of gift card options. You can reach out to
          us via phone at{" "}
          ...
          headquarters are situated in the vibrant city of Beirut, embodying our
